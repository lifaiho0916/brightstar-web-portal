...
$routes->group('app', ['namespace' => 'App\Controllers'], function($routes) {
    ...
    $routes->post('loadProfile', 'AppController::loadProfile'); 
    $routes->post('uploadNewProfilePicture', 'AppController::uploadNewProfilePicture'); 
    $routes->post('withdrawCommission', 'AppController::withdrawCommission'); 
    $routes->post('loadAllCommissionHistory', 'AppController::loadAllCommissionHistory'); 
    $routes->post('loadSingleCommissionHistory', 'AppController::loadSingleCommissionHistory'); 
    
    $routes->post('loadAllShipment', 'AppController::loadAllShipment'); 
    $routes->post('loadSingleShipment', 'AppController::loadSingleShipment'); 
    $routes->post('assignDeliveryPartner', 'AppController::assignDeliveryPartner'); 
    $routes->post('submitReport', 'AppController::submitReport'); 
    $routes->post('submitPicture', 'AppController::submitPicture'); 
    $routes->post('loadAllShipmentHistory', 'AppController::loadAllShipmentHistory'); 
});
...
// Shipments
$routes->get('getAllShipment', 'ShipmentController::getAllShipment'); 
